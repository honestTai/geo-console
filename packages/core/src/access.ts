export const applicationPermissions = [
	{
		key: "page.customer_knowledge",
		kind: "page",
		group: "内容与整改",
		label: "客户知识资产",
		navigationKey: "customerKnowledge",
		iconKey: "book",
	},
	{
	...
	{ key: "project.archive", kind: "action", group: "客户与建档", label: "封档客户" },
	{ key: "project.delete", kind: "action", group: "客户与建档", label: "删除客户" },
	...
	{ key: "articles.quality.run", kind: "action", group: "文章质检", label: "生成文章质检" },
	{ key: "articles.quality.review", kind: "action", group: "文章质检", label: "复核文章质检" },
	{ key: "articles.review", kind: "action", group: "文章质检", label: "审核文章版本" },
	{ key: "knowledge.assets.manage", kind: "action", group: "客户知识资产", label: "维护客户知识资料" },
	{ key: "knowledge.assets.review", kind: "action", group: "客户知识资产", label: "审核客户知识资料" },
	{ key: "publications.channels.manage", kind: "action", group: "发布交付", label: "管理发布渠道" },
	{ key: "publications.manage", kind: "action", group: "发布交付", label: "管理发布工单" },
	{ key: "publications.execute", kind: "action", group: "发布交付", label: "执行发布与提交回执" },
	{ key: "publications.review", kind: "action", group: "发布交付", label: "复核发布回执" },
...
export const actionParentPages: Record<string, string> = {
	...
	"project.archive": "page.customers",
	"project.delete": "page.customers",
