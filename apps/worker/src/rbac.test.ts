	...
	it("为全部受保护页面和接口登记动态策略", async () => {
		...
		try {
			...
			const cases: Array<[string, string, string]> = [
				...
				["page.knowledge", "GET", "/api/knowledge/export"],
				["knowledge.manage", "POST", "/api/knowledge/import"],
				["knowledge.manage", "DELETE", "/api/knowledge/questions/question"],
				["page.settings", "GET", "/api/settings/hrouter/models"],
				["page.settings", "GET", "/api/settings/export"],
				["page.workbench", "GET", "/api/settings/hrouter/models"],
				["settings.manage", "POST", "/api/settings/import"],
